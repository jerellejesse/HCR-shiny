...
This project focused on testing alternative HCRs performance under a range of current groundfish conditions and stock assessment issues.<br>
  * **It did not test:**
...
1. **Home:** Introduces the rationale, goals, approach of the project. This page also links to the full report, executive summary, and GRMI project site. Further down the page there are also tabs that explain the alternate HCRs, scenarios, and performance metrics in more detail. There is also glossary and acknowledgment tabs included here. <br>

2. **Stock Performance:** Results from the MSE pertaining to the stock are displayed here by choosing model specifications, clicking "create plots" and moving across the tabs to see different performance metrics. <br>

3. **Assessment Performance:** Results from the MSE pertaining to the stock assessment are displayed here by choosing model specifications, clicking "create plots" and moving across the tabs to see different performance metrics. <br>

4. **Management Performance:** Results from the MSE pertaining to the stock management are displayed here by choosing model specifications, clicking "create plots" and moving across the tabs to see different performance metrics. <br>
    * **User specifies:** 
...
5. **Compare Scenarios:** Compare scenarios based on guided prompts with choice of HCRs and performance metrics. 
