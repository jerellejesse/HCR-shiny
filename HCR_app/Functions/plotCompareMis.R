plotCompareMis <- function(comp,miss,hcr, plottype)
{
  ...
  p<-ggplot()+geom_line(data=df,aes(x=Year,y=SSBest, color=HCR,linetype=Misspecification, alpha="Estimated"), size=1)+
  ...
  p<- ggplot()+geom_line(data=df,aes(x=Year,y=SSBest, color=HCR,linetype=Rho, alpha="Estimated"), size=1)+
    ...
    if(comp == "Misspecified and correctly specified stock assessment"){
      ...
      if(miss == 4){
       ...
       p2<- ggplot()+geom_line(data=df,aes(x=Year,y=Fest, color=HCR,linetype=Misspecification, alpha="Estimated"), size=1)+
     ...
     p2<- ggplot()+geom_line(data=df,aes(x=Year,y=Fest, color=HCR,linetype=Rho, alpha="Estimated"), size=1)+
